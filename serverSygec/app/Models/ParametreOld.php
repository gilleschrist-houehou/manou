...
class Parametre extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['adresseServeur', 'adresseServeurFichier', 'logo', 'adresse', 'piedPage', 'ua_finale_courrier_initie', 'marge', 'tailletexte', 'created_by', 'updated_by', 'created_at', 'updated_at'];

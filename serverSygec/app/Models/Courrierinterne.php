...
class Courrierinterne extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\Uniteadmin', 'expediteur_code', 'code');
    }

    public function uniteadmindestinataire()
    {
        return $this->belongsTo('App\Models\Uniteadmin', 'recepteur_code', 'code');
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function courrierinitiedepart()
    {
        return $this->belongsTo('App\Models\Courrierinitie', 'courrierinitiedepart_code', 'code');
    }
    /**
    ...
    {
        return $this->hasMany('App\Models\Noteexplicative', 'courrierinterne_code', 'code');
    }
    ...
    {
        return $this->hasMany('App\Models\Affectation', 'courrierinterne_code', 'code');
    }

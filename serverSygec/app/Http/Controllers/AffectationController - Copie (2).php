    ...
    public function classerinterne(Request $request)
 {
        try { 
           ...
           $uacode=$userconnectdata->agent->uniteadmin->code;
            ...
            $uniteadmin_ordonnateur_code=Affectation::where("courrierinterne_code","=",$courrier_code)->pluck("uniteadmin_ordonnateur_code");
              /*Affectation::where("courrierinterne_code","=",$courrier_code)->where("uniteadmin_code","=",$uacode)->update(["statut" =>1]);*/

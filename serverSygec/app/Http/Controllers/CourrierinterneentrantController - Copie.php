...
/**
    ...
    public function getListForDirecteur(Request $request)
    {
        try {
            ...
            //Récupérer l'unité administrative de l'agent connecté
             ...
             $query = Courrierinterne::with(['uniteadmin','typecourrier','fichier',
              ...
              'affectations','affectations.uniteadmin','affectations.directive',
              'parcours','parcours.user','parcours.user.agent','parcours.etapecourrierentrant',
              'courrierinitie','courrierinitie.paraphes','courrierinitie.signatures'])->where('recepteur_code','=',$uniteadmin_code)->where('transmission','=',1)->where('finAffectation','=',0)->orWhereHas('affectations', function($q) use($uniteadmin_code) {
                        $q->where('uniteadmin_code', '=', $uniteadmin_code)->where('courrierinterne_code','!=','')->where('finAffectation','=',0);

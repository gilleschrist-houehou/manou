...
<head>
    ...
    <!-- Title Page-->
    <title>Manou | Administration</title>
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img style="max-width: 88% !important;" src="{{ asset('/public/dist-admin/images/icon/logo.png') }}" alt="CoolAdmin" />
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        @endif">
                            <a href="{{ route('admin.annonces.index') }}">
                                <i class="fas fa-bullhorn"></i>Annonces</a>
                        </li>
                        @if(Auth::user()->niveau=="SuperAdmin")
                        <li class="
                        @if($segment=='publicites')
                        active
                        @endif">
                            <a href="{{ route('admin.publicites.index') }}">
                                <i class="fas fa-table"></i>Publicités</a>
                        </li>
                        @endif
                        <li class="
                        ...
                        @endif">
                            <a href="{{ route('admin.recrutements.index') }}">
                                <i class="fas fa-bullhorn"></i>Recrutements</a>
                        </li>
                        @if(Auth::user()->niveau=="SuperAdmin")
                        <li class="
                        @if($segment=='annonceurs')
                        active
                        @endif">
                            <a href="{{ route('admin.annonceurs.index') }}">
                                <i class="far fa-check-square"></i>Annonceurs</a>
                        </li>
                        @endif
                    </ul>
                </div>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{ asset('/public/dist-admin/images/icon/logo.png') }}" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('/public/dist-admin/images/icon/avatar-06.jpg') }}" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('/public/dist-admin/images/icon/avatar-04.jpg') }}" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    {{-- <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('/public/dist-admin/images/icon/avatar-06.jpg') }}" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('/public/dist-admin/images/icon/avatar-05.jpg') }}" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('/public/dist-admin/images/icon/avatar-04.jpg') }}" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{ asset('/public/dist-admin/images/icon/avatar-01.jpg') }}" alt="{{ Auth::user()->name }}" />
                                            {{-- <i class="fa fa-user img-responsive" style="width: 45px;height: 45px; font-size: 24px;"></i> --}}
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="{{ asset('/public/dist-admin/images/icon/avatar-01.jpg') }}" alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                                            ...
                                            <div class="account-dropdown__footer">
                                                    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="zmdi zmdi-power"></i>{{ __('Déconnexion') }}
                                                    </a>
    ...
    <script src='{{ asset('/public/vendor/froala/js/froala_editor.pkgd.min.js') }}'></script>
    <script src='{{ asset('/public/vendor/froala/js/languages/fr.js') }}'></script>

   {{--  <!-- Include the language file. -->
    <script src='{{ asset('/public/vendor/froala/js/languages/es.js') }}'></script>
    <script>
      $(function() {

                            ...
                            <div class="col-md-10">
                                <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="{{route('admin.annonces.update',$annonces->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-sm-9">
                                                        <input type="text" id="title" name="title" placeholder="" class="form-control" value="{{$annonces->title}}" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <textarea name="description" id="description" rows="9" placeholder="" class="form-control" required>{{$annonces->description}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                    ...
                                                    <div class="col-md-9">
                                                      <img src="{{asset('/public/storage/annonces/images/'.$annonces->image)}}" style="width: 550px;">
                                                    </div>

                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <a href="{{ route('admin.annonces.create') }}" class="au-btn au-btn-icon au-btn--blue">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="{{route('admin.annonces.edit',$an)}}" class="item" data-toggle="tooltip" data-placement="top" title="Editer">
                                                        ...
                                                        <form id="activer" action="{{route('admin.annonces.visibility', $an->id)}}" method="post">
                                                        ...
                                                        <form id="desactiver" action="{{route('admin.annonces.visibility', $an->id)}}" method="post">
                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                        </form>
                                                        @endif
                                                        ...
                                                        <form id="supprimer" action="{{route('admin.annonces.destroy', $an->id)}}" method="post">
